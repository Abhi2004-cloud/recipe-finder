  ...
  return (
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit} className="row g-3" encType="multipart/form-data">
        ...
        <div className="col-md-6">
          <input type="text" name="cuisine" placeholder="Cuisine" className="form-control" onChange={handleChange} required />
        </div>
        <div className="col-12">
          <textarea name="ingredients" placeholder="Ingredients" rows="3" className="form-control" onChange={handleChange} required />
        </div>
        <div className="col-12">
          <textarea name="instructions" placeholder="Instructions" rows="4" className="form-control" onChange={handleChange} required />
        </div>
        <div className="col-12">
